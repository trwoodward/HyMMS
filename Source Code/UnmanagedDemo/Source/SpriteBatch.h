...
public:
	...
	void Draw(Texture2D* texture, DemoRectangle destRect, DemoColour col);
	void Draw(Texture2D* texture, float* position, DemoRectangle* srcRect, DemoColour col, float angle, float* origin, float* scale);
...
private:
	struct Sprite
	{
		...
		Sprite() {}
		Sprite( Texture2D* a_texture, DemoRectangle a_rect, DemoColour a_col) : texture(a_texture), col(a_col) 
		{
		...
		Sprite(Texture2D* a_texture, float* position, DemoRectangle* a_src_rect, DemoColour a_col, float angle, float* origin, float* scale) : texture(a_texture), col(a_col) 
		{
